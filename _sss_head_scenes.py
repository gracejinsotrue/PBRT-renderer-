...
#
# usage: python _sss_head_scenes.py [--preview]
import os, sys, math

HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "scenes", "final_scenes", "head2")
...
<!-- %s
     ...
     Generated by _sss_head_scenes.py - edit that, not this file. Camera,
